-- Drop existing tables before rebuilding (keeps database name unchanged)
...
copy membership
FROM 'R:\Projects\Logistics Operations Analytics\dataset\Membership.csv'
DELIMITER ','
CSV HEADER;
...
COPY customer
FROM 'R:\Projects\Logistics Operations Analytics\dataset\Customer.csv'
DELIMITER ','
CSV HEADER;

-- Load Employee Details Dataset
copy employee_details
FROM 'R:\Projects\Logistics Operations Analytics\dataset\Employee_Details.csv'
DELIMITER ','
CSV HEADER;

-- Load Shipment Details Dataset
copy shipment_details
FROM 'R:\Projects\Logistics Operations Analytics\dataset\Shipment_Details.csv'
DELIMITER ','
CSV HEADER;

-- Load Status Dataset
copy status
FROM 'R:\Projects\Logistics Operations Analytics\dataset\Status.csv'
DELIMITER ','
CSV HEADER;

-- Load Payment Details Dataset
copy payment_details
FROM 'R:\Projects\Logistics Operations Analytics\dataset\Payment_Details.csv'
DELIMITER ','
CSV HEADER;

-- Load Employee Shipment Dataset
copy employee_manages_shipment
FROM 'R:\Projects\Logistics Operations Analytics\dataset\employee_manages_shipment.csv'
DELIMITER ','
CSV HEADER;
...
TO 'R:\Projects\Logistics Operations Analytics\dataset\Customer_Payments.csv'
DELIMITER ','
CSV HEADER;
